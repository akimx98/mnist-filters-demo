...
def validation_func_score_fixed(errors, answers):     
    ...
    if score_10 == nb_errors:
        ...
        errors.append("Ce n'est pas la bonne valeur. Note la réponse donnée par ton algorithme pour chaque {challenge.strings['dataname']} et compte le nombre de différences avec les bonnes réponses.")
